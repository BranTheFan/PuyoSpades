--- STEAMODDED HEADER
--- MOD_NAME: Puyo Puyo Spades
--- MOD_ID: Puyo_Spades
--- PREFIX: PP
--- MOD_AUTHOR: [Bran]
--- MOD_DESCRIPTION: Puyo Puyo Spades
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: FC03DF

local atlas_key = 'PP'-- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'PP_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'PP_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'spades'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King"} -- Which ranks to replace

local description = 'Puyo Puyo' -- English-language description, also used as default
